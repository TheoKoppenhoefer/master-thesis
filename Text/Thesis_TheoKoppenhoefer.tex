...
We start by requiring some regularity for the boundary of $\Omega$.
...
\nomenclature{$u_j$}{Restriction of $u$ to the cotangent bundle $T^*X_j$, see equation \ref{eq:def_projectionStratification}}
...
%   Assume further that $\Sigma^-$ is connected. Then $f$ cannot have an interiour critical point.
% \end{proposition}
% \begin{proof}
...
%   the interiour of $X$ lies to the left of $\gamma$.
...
%   the interiour type numbers of $u$
%   \begin{align*}
%     M_2=M_1\,.
%   \end{align*}
% \end{proposition}
