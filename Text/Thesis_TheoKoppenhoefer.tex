...
Since this flow would leave the domain at the entrant boundary the vector field is modified on $\Sigma^{\leq0}$ 
...
Notice that it follows from the definition that a stagnation point of $u_j$ is irregular if it
