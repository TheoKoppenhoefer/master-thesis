...
\end{definition}
\td{$n(k)=0$ or $n(k)=n(j)+1$ a little unclear. Also $X_0\precsim X_0$ unclear.}
...
\begin{example}\label{ex:n2_hvf_canonical}
  ...
  \begin{align}
    \brk*{C_xX}^*=C_xX\,.\label{eq:n2_hvf_canonical}
  \end{align}
...
\begin{remark}[Contingent cone]
  ...
  Thus equation \eqref{eq:n2_hvf_canonical} in the previous example is a special case for $\alpha=\pi/2$.
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
      ...
      \caption{$\alpha<\pi/2$}
    \end{subfigure}
    \caption{Illustration of a planar contingent cone (yellow) and its polar cone (red).}
...
in the analoga to lemmas \ref{le:Morse_homotopicNoCP} and \ref{le:Morse_homotopicCP} directly how the Betti numbers of the manifold
...
\end{proposition}
\begin{proof}
  See \cite[Corollary 2.24]{Hatcher2002}.
\end{proof}
