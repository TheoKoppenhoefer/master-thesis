...
\begin{proposition}[Smoothness]
  For any $\eta>0$ and $\e>0$ sufficiently small (that is $r$ sufficiently large) the variety $V\brk*{p^\e}$ is smooth.
  % \begin{itemize}
  %   \item $C_\eta^r=r\brk*{S^2\setminus\tubular_\eta\brk*{\R e_3}}$
  %   \item $\tubular_\eta\brk*{\R e_3}$
  % \end{itemize}
\end{proposition}
\begin{proof}
  ...
  \begin{align}
    V_U\brk*{P,Q,R_1,R_2,R_3}=\emptyset\,.\label{eq:n3_ex_smoothness_varCond}
  \end{align}
  Indeed, consider the variety
  \begin{align}
    V\brk*{P,R_1,R_2,R_3} \label{eq:n3_ex_smoothness_subvar}
  \end{align}
  Maple calculates the Gröbner basis with lexicographic order $x<y<z$
  \begin{align*}
    4x_1^8 - 18x_1^7 + 48x_1^6 - 66x_1^5 + 37x_1^4 - 5x_1^3 \\
    4x_1^5x_2 - 14x_1^4x_2 + 34x_1^3x_2 - 32x_1^2x_2 + 5x_1x_2 \\
    4x_1^7 + 2x_1^6 + 58x_1^5 - 116x_1^4 + 52x_1^3 + 85x_1x_2^2 \\
    16x_1^4x_2 - 44x_1^3x_2 + 35x_1^2x_2 + 17x_2^3 - 4x_1x_2 \\
    8x_1^4x_2 - 22x_1^3x_2 + 60x_1^2x_2 - 36x_1x_2 + 17x_1x_3 \\
    -4x_1^7 - 2x_1^6 - 58x_1^5 + 116x_1^4 - 137x_1^3 + 85x_1^2 - 85x_2^2 + 170x_2x_3 \\
    12x_1^7 + 6x_1^6 - 166x_1^5 + 332x_1^4 - 269x_1^3 + 85x_1^2 - 255x_2^2 + 170x_3^2
  \end{align*}
...
\end{proposition}
\begin{proof}
  Once again we consider the variety $V\brk*{P,Q}$. We parametrise $V(Q)$ in a neighbourhood $U$ around the point $re_3$ to obtain
  \begin{align}
    V_U\brk*{P,Q}=V_U\brk*{\underbrace{-x_1^3+x_1x_2^2+x_1^2-x_2^2+x_2\sqrt{r^2-x_1^2-x_2^2}}_{=\tiP}}
  \end{align}
  Now let $x\in S^1$ be close to $e_3$. Then we have that
  \begin{align}
    \frac{1}{r^3}\tiP\brk*{rx}=\brk*{\tiP}_3(x)+\frac{1}{r}\brk*{\tiP}_2(x)=\tiP^\e(x)
  \end{align}
  Now observe that $\brk*{\tiP}_3=-x_1^3+x_1x_2^2$ is a monkey saddle and thus $V_U\brk*{\brk*{\tiP}_3}$ is 
  similar to figure \ref{fi:n3_polynomial_intersectionOriginDegenerate}.
  We denote by
  \begin{align*}
    \alpha=\brk[c]*{t\vect{1 & -1}^\top\colon t\in\R}
  \end{align*}
  an arc of  $V_U\brk*{\brk*{\tiP}_3}$.
  We also observe that the $V_U\brk*{\brk*{\tiP}_2}$ looks similar to figure \ref{}.
  Here too we remark that
  \begin{align}
    \beta=\brk[c]*{ t\in\R}
  \end{align}
  is a zero set of $V_U\brk*{\brk*{\tiP}_2}$.
  This is depicted in figure \ref{fi:n3_polynomial_intersectionOriginOtherTerm}.
  
  We now look at the second quadrant. Here we have that
  $\tiP^\e=\brk*{\tiP}_3\leq0$ on $\beta$ and that
  $\tiP^\e=\brk*{\tiP}_2\geq0$ on $\alpha$. By the intermediate value theorem thus there must be an arc
