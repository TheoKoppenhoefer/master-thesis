...
\begin{proof}
  ...
  \begin{align*}
    ...
    =V_{B_{1/2}}\brk*{P_1\brk*{\e,\cdot_1,\cdot_2,\sqrt{1-\cdot_1^2-\cdot_2^2}}}
...
\begin{proof}
  ...
  \begin{align*}
    V\brk*{P_1,p_2}\cap \Omega_x=\brk[c]*{\varphi(x)=I\brk*{y,g_x(y)}\colon y\in\omega_x}\,.
  \end{align*}
...
\begin{proof}
  ...
  and observe that
  \begin{align}
    \tiP_1(\e,x)=\brk*{\tip_1}_3+\e\brk*{\tip_1}_{\leq2}\,.\label{eq:n3_polynomial_regularH_relTiP}
  \end{align}
  ...
  As noted earlier $\brk*{\tip_1}_3=-x_1^3+3x_1x_2^2$ is a monkey saddle
  and $V_W\brk*{\brk*{\tip_1}_3}=\tiA$ is
  similar to figure \ref{fi:n3_polynomial_intersectionOriginDegenerate}.
  The signs in the figure indicate the sign of $\brk*{\tip_1}_3$ in a given region.
  Since we have
  $$\brk*{\tip_1}_{\leq2}=x_1^2-x_2^2+x_2\sqrt{1-x_1^2-x_2^2}$$
  we obtain that $\nabla \brk*{\tip_1}_{\leq2}(0)=e_2$ and $\brk*{\tip_1}_{\leq2}(0)=0$.
  Hence we observe that the $V_W\brk*{\brk*{\tip_1}_{\leq2}}$ looks similar to figure \ref{fi:n3_polynomial_intersectionOriginOtherTerm}
  for a sufficiently small neighbourhood $W$.
  More concretely we choose $W$ so small that the arc $\tibeta=V_W\brk*{\brk*{\tip_1}_{\leq2}}$ has positive distance to $\tiA\cap \tiU_\rho$ for
  ...
  Indeed, consider the first quadrant.
  Here we have that
  $\tiP_1(\e,\cdot)=\brk*{\tip_1}_3\leq0$ on $\tibeta$ and that
  $\tiP_1(\e,\cdot)=\brk*{\tip_1}_{\leq2}\geq0$ on $\tialpha^+$. By the intermediate value theorem thus there must be for each
  ...
  \begin{figure}
    ...
    \caption{Sketch of the set $V\brk*{\brk*{\tip_1}_3}$.}
    ...
    \caption{Sketch of the set $V\brk*{\brk*{\tip_1}_{\leq2}}$.}
