...
\begin{frame}
  \begin{proposition}[Negative answer for cylinders, {\cite{Wahlen2023}} or {\cite[Prop.\ 5.1]{Koppenhoefer2024}}]\label{pr:n3_inflowOutflowCylinder}
...
\begin{frame}
  \begin{proposition}[Condition on the interior type numbers, {\cite[Prop.\ 5.2]{Koppenhoefer2024}}]\label{pr:n3_inflowOutflowRels}
...
\begin{frame}
  \begin{example}[A harmonic function with interior critical points and connected entrant and emergent boundaries, {\cite[Ex.\ 5.3]{Koppenhoefer2024}}]
...
\begin{frame}
  ...
  \begin{proposition}[Condition on the number of stagnation points, {\cite[Prop.\ 6.5]{Koppenhoefer2024}}]\label{pr:n2_hvf_noInflowNoOutflow}
...
\begin{frame}
  \begin{example}[Stagnation points on the boundary, {\cite[Ex.\ 6.9]{Koppenhoefer2024}}]
...
\begin{frame}
  \begin{proposition}[Condition on the domain topology, {\cite[Prop.\ 6.11]{Koppenhoefer2024}}]\label{pr:n3_domainCond}
...
\begin{frame}
  \begin{corollary}[Condition on the type numbers and domain, {\cite[Cor.\ 6.12]{Koppenhoefer2024}}]\label{co:n3_conditionTypeNbrII}
